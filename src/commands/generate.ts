      ...
      if (data.outboundAdapters.includes("in-memory")) {
        files.push({
          path: path.join(
            ...
            "out",
            "persistence",
            `in-memory-${data.name}.repository.ts`,
          ),
      ...
      if (data.outboundAdapters.includes("database")) {
        files.push({
          path: path.join(
            ...
            "out",
            "persistence",
            `database-${data.name}.repository.ts`,
          ),
        ...
        files.push(
          {
            path: path.join(
              ...
              "in",
              "routes",
              `${data.name}.validation.ts`,
            ),
            content: t.generateTanStackValidationTemplate(data),
            layer: "Route Validation",
          },
          {
            path: path.join(
              resourcePath,
            ...
            content: t.generateTanStackLoaderTemplate(data),
            layer: "Route Loader",
          },
          {
            path: path.join(
              ...
              "in",
              "routes",
              `${data.name}.component.ts`,
            ),
            content: t.generateTanStackComponentTemplate(data),
          ...
          },
          {
            ...
            content: t.generateTanStackRouteTemplate(data),
          ...
          },
          {
            path: path.join(
              ...
              "in",
              "routes",
              `${data.name}.detail-route.ts`,
            ),
            content: t.generateTanStackDetailRouteTemplate(data),
            layer: "Detail Route",
          },
          {
            path: path.join(
              ...
              "in",
              "routes",
              `${data.name}.detail-component.ts`,
            ),
            content: t.generateTanStackDetailComponentTemplate(data),
          ...
          files.push(
            {
              ...
              content: h.generateHonoValidationTemplate(data),
            ...
            },
            {
              path: path.join(
                ...
                "in",
                "http",
                `${data.name}.controller.ts`,
              ),
              content: h.generateHonoControllerTemplate(data),
            ...
            },
            {
              ...
              content: h.generateHonoRoutesTemplate(data),
              layer: "HTTP Routes",
            },
            {
              path: path.join(
                ...
                "in",
                "http",
                `${data.name}.routes.test.ts`,
              ),
              content: h.generateHonoRoutesTestTemplate(data),
              layer: "HTTP Routes Test",
            },
          );
          ...
          files.push(
            {
              ...
              content: e.generateExpressValidationTemplate(data),
              layer: "HTTP Validation",
            },
            {
              path: path.join(
              ...
              content: e.generateExpressControllerTemplate(data),
              layer: "HTTP Controller",
            },
            {
              path: path.join(
              ...
              content: e.generateExpressRoutesTemplate(data),
              layer: "HTTP Routes",
            },
            {
              path: path.join(
              ...
              content: e.generateExpressRoutesTestTemplate(data),
              layer: "HTTP Routes Test",
            },
          );
        } else {
          ...
          files.push(
            {
              ...
              content: f.generateFastifyValidationTemplate(data),
              layer: "HTTP Validation",
            },
            {
              path: path.join(
                ...
                "in",
                "http",
                `${data.name}.handler.ts`,
              ),
              content: f.generateFastifyHandlerTemplate(data),
              layer: "HTTP Handler",
            },
            {
              path: path.join(
              ...
              content: f.generateFastifyRoutesTemplate(data),
              layer: "HTTP Routes",
            },
            {
              path: path.join(
              ...
              content: f.generateFastifyRoutesTestTemplate(data),
              layer: "HTTP Routes Test",
            },
          );
        }
        ...
        files.push(
          {
            path: path.join(
              ...
              "in",
              "websocket",
              `${data.name}.ws-handler.ts`,
            ),
            content: shared.generateWebSocketHandlerTemplate(data),
          ...
          },
          {
            path: path.join(
              ...
              "in",
              "websocket",
              `${data.name}.ws-routes.ts`,
            ),
            content: shared.generateWebSocketRoutesTemplate(data),
            layer: "WebSocket Routes",
          },
        );
      }
    ...
    collectRootFile(resourcePath, data) {
      if (frameworkName === "hono") {
        return {
          ...
          content: (fw as typeof hexHono).generateHonoCompositionRootTemplate(
            data,
          ),
        ...
        return {
          path: path.join(resourcePath, "index.ts"),
          content: (
            fw as typeof hexExpress
          ).generateExpressCompositionRootTemplate(data),
          layer: "Composition Root",
        };
        ...
        return {
          path: path.join(resourcePath, "index.ts"),
          content: (
            fw as typeof hexTanStack
          ).generateTanStackCompositionRootTemplate(data),
          layer: "Composition Root",
        };
      }
      return {
        path: path.join(resourcePath, "index.ts"),
        content: (
          fw as typeof hexFastify
        ).generateFastifyCompositionRootTemplate(data),
        layer: "Composition Root",
      };
    },
  };
...
function buildGoHexagonalRegistry(go: typeof hexGo): TemplateRegistry {
  return {
      ...
      return [
        {
          path: path.join(
            resourcePath,
            "domain",
            `${data.kebabName}.entity.go`,
          ),
          content: go.generateGoEntityTemplate(data),
          layer: "Domain Entity",
        },
        {
          path: path.join(
            ...
            "domain",
            "ports",
            `${data.kebabName}_repository.go`,
          ),
          content: go.generateGoRepositoryPortTemplate(data),
          layer: "Repository Port",
        },
        {
          path: path.join(
            ...
            "domain",
            "ports",
            `${data.kebabName}_service.go`,
          ),
          content: go.generateGoUseCasePortTemplate(data),
          layer: "Use Case Port",
        },
      ];
    },
      ...
      return [
        {
          ...
          content: go.generateGoUseCaseTemplate(data),
    ...
    collectOutboundFiles(resourcePath, data) {
      ...
      if (data.outboundAdapters.includes("in-memory")) {
        files.push({
          ...
          content: go.generateGoInMemoryRepositoryTemplate(data),
          layer: "In-Memory Repository",
        });
      }
      return files;
    ...
    collectRootFile(resourcePath, data) {
      return {
        path: path.join(resourcePath, `${data.kebabName}_module.go`),
        content: go.generateGoCompositionRootTemplate(data),
        layer: "Module Composition Root",
      };
    },
  };
}
...
export async function generate(
  ...
  try {
    ...
    spinner.succeed(
      chalk.green(`Successfully generated ${data.capitalizedName} API!`),
    );
...
export async function addAdapters(
  ...
  try {
    ...
    const allInbound = resolveCurrentInboundAdapters(
      resource,
      direction === "inbound" ? data.inboundAdapters : [],
    );
    const allOutbound = resolveCurrentOutboundAdapters(
      resource,
    ...
    if (direction === "outbound") {
      ...
      files = registry.collectInboundFiles(resourcePath, {
        ...data,
    ...
    spinner.succeed(
      chalk.green(`Successfully added adapters to ${data.capitalizedName}!`),
    );
    printSummary(files, data);
  } catch (error) {
...
function resolveCurrentInboundAdapters(
  resource: ExistingResourceInfo,
  newAdapters: InboundAdapter[],
): InboundAdapter[] {
  const adapters: InboundAdapter[] = [...newAdapters];
  if (resource.hasHttp && !adapters.includes("http")) adapters.push("http");
  if (resource.hasWebSocket && !adapters.includes("websocket"))
    adapters.push("websocket");
  return adapters;
}

function resolveCurrentOutboundAdapters(
  resource: ExistingResourceInfo,
  newAdapters: OutboundAdapter[],
): OutboundAdapter[] {
  const adapters: OutboundAdapter[] = [...newAdapters];
  if (resource.hasInMemory && !adapters.includes("in-memory"))
    adapters.push("in-memory");
  if (resource.hasDatabase && !adapters.includes("database"))
    adapters.push("database");
...
function printSummary(files: FileToGenerate[], data: TemplateData): void {
  ...
  console.log(
    chalk.gray(
      `  1. Update the entity properties in ${chalk.white(data.name + "/")}`,
    ),
  );
  console.log(
    chalk.gray(`  2. Import from the composition root in your main app:`),
  );
  console.log(
    chalk.yellow(
      `     import { ${data.camelCaseName}Routes } from './${data.name}';`,
    ),
  );
}
