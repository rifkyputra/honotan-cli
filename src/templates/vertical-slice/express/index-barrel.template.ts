...
export function generateVsExpressIndexTemplate(data: TemplateData): string {
...
export const ${camelCaseName}Router = create${capitalizedName}Routes(${camelCaseName}Service);
